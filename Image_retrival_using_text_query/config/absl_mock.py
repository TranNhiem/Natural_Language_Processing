...
class Mock_Flag(object):
    ...
    def DEFINE_enum(self, var_name, value, choice_lst, helper_str):
        ...
        if value in choice_lst:
            ...
            raise TypeError(
                "The input value should be belong into the choice list")
...
def local_test():
    ...
    flag_inst.DEFINE_float(
        "lucky_num", 13.35, "This is my lucky number, you may got one")
    flag_inst.DEFINE_boolean("lawyer", True, "lawyer said the True ~ ~")
    flag_inst.DEFINE_string("name", "no_name", "just kidding@@")
    flag_inst.DEFINE_enum(
        "car", "tesla", ("honda", "tesla", "foxconn"), "foxconn not bad..")
